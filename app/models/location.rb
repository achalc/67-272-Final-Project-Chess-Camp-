class Location < ActiveRecord::Base
  ...
  def create_map_link(zoom=15,width=800,height=800)
    ...
    map = "http://maps.google.com/maps/api/staticmap?center= #{latitude},#{longitude}&markers=color:red%7Ccolor:red%7Clabel:#{i}%7C#{latitude},#{longitude}&zoom=15&size=800x800&maptype=roadmap&sensor=false"
  end
